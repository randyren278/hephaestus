...
<p align="center">
  <img src="docs/assets/pixel/champion-icon.svg" width="40" height="40" alt="Pixel-art Champion crest icon">
  <img src="docs/assets/pixel/gene-icon.svg" width="40" height="40" alt="Pixel-art Gene double-helix icon">
  <img src="docs/assets/pixel/canary-icon.svg" width="40" height="40" alt="Pixel-art canary icon">
  <br/>
  <sub>Block-glyph icons generated by <a href="scripts/pixel_art/generate.py"><code>scripts/pixel_art/generate.py</code></a>, same palette as the hero and the web console.</sub>
</p>
